 ...
 */
//NOSONAR
public class PresenceListenerExample implements PresenceListener {


    private final Logger logger = LoggerFactory.getLogger(PresenceListenerExample.class);
    private SymphonyClient symClient;

    public PresenceListenerExample() {
    ...
    public void onEvent(SymPresence symPresence) {
        ...
        logger.info("Received updated presence event from: {}:{}:{}", symPresence.getTimestamp(), symPresence.getUserId(), symPresence.getCategory());
