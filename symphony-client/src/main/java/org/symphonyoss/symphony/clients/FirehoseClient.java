...
public interface FirehoseClient {
    SymFirehose createFirehose() throws DataFeedException;

    List<SymEvent> getEventsFromFirehose(SymFirehose symFirehose, SymFirehoseRequest symFirehoseRequest) throws DataFeedException;
}
