...
/**
 * Generic exception used by {@link UserManagementClient}
 */
public class UserManagementClientException extends SymException {
    public UserManagementClientException(String message) {
        super(message);
    }
